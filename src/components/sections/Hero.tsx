...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Mobile scrim - keeps the headline + copy legible over the product photo */}
      <div className="lg:hidden absolute inset-0 z-0 bg-gradient-to-b from-saltd-cream via-saltd-cream/85 to-transparent" />
